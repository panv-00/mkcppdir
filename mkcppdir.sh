...
then
  ...
  echo "void usage_error(int nlines, const char *lines[]);" >> "$PWD/$1/src/$1_functions.h"
  echo "" >> "$PWD/$1/src/$1_functions.h"
  ...
  echo "void usage_error(int nlines, const char *lines[])" >> "$PWD/$1/src/$1_functions.cpp"
  echo "{" >> "$PWD/$1/src/$1_functions.cpp"
  echo "  for (int i = 0; i < nlines; i++)" >> "$PWD/$1/src/$1_functions.cpp"
  echo "  {" >> "$PWD/$1/src/$1_functions.cpp"
  echo "    printf(\"%s\\n\", lines[i]);" >> "$PWD/$1/src/$1_functions.cpp"
  echo "  }" >> "$PWD/$1/src/$1_functions.cpp"
  echo "}" >> "$PWD/$1/src/$1_functions.cpp"
  ...
  echo "    };" >> "$PWD/$1/src/$1.cpp"
  echo "    usage_error(2, msg);" >> "$PWD/$1/src/$1.cpp"
  echo "    return 1;" >> "$PWD/$1/src/$1.cpp"
  echo "  }" >> "$PWD/$1/src/$1.cpp"
  echo "" >> "$PWD/$1/src/$1.cpp"
